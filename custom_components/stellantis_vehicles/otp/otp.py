...
class InweboOTP:
    ...
    def compute_r_values(self):
        ...
        # r2_source ends with the raw PIN on the synchro action; keep it out of the log.
        r2_log = r2_source.replace(self.pin_code, "###") if self.action == "synchro" and self.pin_code else r2_source
        logger.debug("%s\n%s\n%s", r0_source, r1_source, r2_log)
